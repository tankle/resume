...
\section{教育背景}
\cventry{2013--至今}{硕士 \textnormal{(计算机科学与技术)}}{哈尔滨工业大学深圳研究生院}{GPA: 3.516 专业前15\%(15/118)}{}{导师: 王晓龙教授 \newline 研究方向: 自然语言处理，机器学习，信息检索 \newline 毕业时间：2015年12月}
\cventry{2009--2013}{学士}{杭州电子科技大学}{}{}{}


\section{研究项目}
\cvitem{NTCIR-11 Temporalia}{时间信息检索评测，是在搜索引擎的搜索过程中，考虑查询时间和结果文档中的时间信息，使得搜索结果更加准确。我们的评测结果获得国际第二, 并发表论文《HITSZ-ICRC at NTCIR-11 Temporalia Task》\cite{hou2014hitsz}}
\cvitem{SemEval-2015 task3}{社区问答中答案选择任务(Answer Selection in Community Question Answering)，是指在社区问答中，对每个问题的答案的好坏进行判定。该任务包含两种语言：Arabic和English。在Arabic子任务中，我们组（HITSZ-ICRC）取得了第三名，在English子任务中，获得了第二名。\cite{hou-EtAl:2015:SemEval1}}
\cvitem{SemEval-2015 task5}{QA TempEval 是指以问答的方式来评价对文本中时间信息的理解程度。主要涉及三个方面：1. 文本中时间的抽取和归一化，2. 事件的抽取， 3. 事件和时间、事件与事件之间关系的抽取。\cite{hou-EtAl:2015:SemEval2}}
