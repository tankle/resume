...
\section{教育背景}
\cventry{2013--至今}{硕士 \textnormal{(计算机科学与技术)}}{哈尔滨工业大学深圳研究生院}{GPA: 3.516 专业前15\%(15/118)}{}{导师: 王晓龙教授 \newline 研究方向: 自然语言处理，机器学习，信息检索，问答系统 \newline 毕业时间：2015年12月}
\cventry{2009--2013}{学士}{杭州电子科技大学}{}{}{}


\section{研究项目}
\cvitem{NTCIR-11 Temporalia}{时间信息检索评测：在搜索引擎的搜索过程中，考虑查询时间和结果文档中的时间信息，使得搜索结果更加准确。我们的评测结果获得国际第二（共有9只队伍）, 并发表论文《HITSZ-ICRC at NTCIR-11 Temporalia Task》\cite{hou2014hitsz}。
\newline	主要工作：使用Solr对文档建立索引和检索，抽取问句和搜索结果的特征,包括文本特征和时间特征，使用Learning to Rank算法对搜索结果进行重排序。}
\cvitem{SemEval-2015 task3}{社区问答中答案选择任务(Answer Selection in Community Question Answering)，是指在社区问答中，对每个问题的答案质量进行判定。该任务包含两种语言：Arabic和English。在Arabic子任务中，我们组（HITSZ-ICRC）取得了第三名，在English子任务中，获得了第二名（共有12只队伍）\cite{hou-EtAl:2015:SemEval1}。
\newline	主要工作：抽取文本特征，比如BOW、tf-idf、词共现等，也尝试过结合word2vec词向量特征，使用集成型方法进行分类。}
...
\cvitem{开源Github}{为Stanford CoreNLP,timeml-qa,caevo等项目提交过代码，主要是修复一些bug等。}
...
\cvitem{\hello}{熟悉主要的数据结构和算法。本科期间获得浙江省第八届程序设计竞赛铜牌。}
